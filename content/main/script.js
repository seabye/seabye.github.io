  ...
  tyin.debug(()=>{
    tyin.runObject({
      ...
      async package_quill_create(){
        // globalThis.tyin_quill=await tyin.package_quill_create(document.body,undefined,'full','some',undefined,false,'100%','100%');
