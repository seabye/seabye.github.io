...
cp -r target/release/machine_tool_pg_rust-pg13/usr/local/share/postgresql/extension/machine_tool_pg_rust--1.0.sql $(echo $(pg_config --sharedir)/extension)/machine_tool_pg_rust--1.0--1.1.sql
cp -r target/release/machine_tool_pg_rust-pg13/usr/local/share/postgresql/extension/machine_tool_pg_rust--1.0.sql $(echo $(pg_config --sharedir)/extension)/machine_tool_pg_rust--1.1--1.0.sql